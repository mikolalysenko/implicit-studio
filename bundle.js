...
},{"./lib/ui.js":2,"./lib/mesh-worker.js":3}],2:[function(require,module,exports){
"use strict"
  ...
  try {
    ...
    for(var i=0; i<3; ++i) {
      if(+shape[i][0].value  >= +shape[i][1].value) {
        handleError(vars[i] + " range is invald")
        return
      }
    }
    rebuildMesh()
...
function handleError(e) {
  error_box.innerHTML = ""
  error_box.appendChild(document.createTextNode(e))
}


},{"gl-shells":4}],3:[function(require,module,exports){
"use strict"
...
},{"isosurface":5,"normals":6}],6:[function(require,module,exports){
var EPSILON = 1e-6;
...
},{"./lib/surfacenets.js":7,"./lib/marchingcubes.js":8,"./lib/marchingtetrahedra.js":9}],4:[function(require,module,exports){
...
},{"./GLOW.js":10,"./shell.js":11,"./viewer.js":12}],7:[function(require,module,exports){
/**
...
},{"events":14,"./GLOW.js":10,"./utils.js":15,"jquery-browserify":16,"arcball":17}],12:[function(require,module,exports){
//Simple mesh viewer
var $             = require("jquery-browserify")
  , GLOW          = require("./GLOW.js").GLOW
  , utils         = require("./utils.js")
...
},{"./GLOW.js":10,"./utils.js":15,"./shell.js":11,"jquery-browserify":16,"normals":18}],17:[function(require,module,exports){
